...
---
This manual covers all the major processes in setting up and using Owrang. The manual is written in a way that the user can manage a self-implementation of the ERP. We recommend that the manual be read first before starting implementation.
