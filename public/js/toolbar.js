...
/* toolbar settings */
wn.provide('owrang.toolbar');

owrang.toolbar.setup = function() {
	// profile
	...
	$user.append('<li><a href="https://owrang.yellowen.com/manual" target="_blank">\
		<i class="icon-fixed-width icon-file"></i> '+wn._('Documentation')+'</a></li>');
	$user.append('<li><a href="http://groups.google.com/group/owrang-user-forum" target="_blank">\
